function robot = POE_chin()
% The model of the robot
robot.n = 6;
robot.g = [0; 0; -9.81];

% The motor between adjacent joint frames generated by MDH parameter
robot.Tj(:, :, 1) = POE_DHmotor([     0;    pi;   -0.283;     0], 1);
robot.Tj(:, :, 2) = POE_DHmotor([     0;  pi/2;        0;  pi/2], 1);
robot.Tj(:, :, 3) = POE_DHmotor([  -0.4;    pi;        0;     0], 1);
robot.Tj(:, :, 4) = POE_DHmotor([ -0.36;    pi; -0.19875; -pi/2], 1);
robot.Tj(:, :, 5) = POE_DHmotor([     0; -pi/2; -0.16975;     0], 1);
robot.Tj(:, :, 6) = POE_DHmotor([     0;  pi/2; -0.14875;     0], 1);
